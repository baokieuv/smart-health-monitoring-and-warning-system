...
import { getPatientDetail, updatePatient, getDoctorsList, allocateDevice, recallDevice, getPatientHealthInfo } from '../../../../frontend/src/utils/api';
...
export default function PatientDetail() {
  ...
  const handleAllocateDevice = async () => {
    ...
    try {
      ...
      if (res?.status === 'success') {
        alert(`Cấp phát thiết bị thành công! Device ID: ${res.data.device_id}`);
  ...
  const loadPatient = async () => {
    ...
    try {
      ...
      if (res?.status === 'success' && res?.data?.patient) {
